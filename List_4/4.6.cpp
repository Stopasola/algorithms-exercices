...
int main(){
	...
	printf("3-Leia a marca de um carro e imprima as informações de todos os carros dessa marca\n");
	printf("4-Leia uma marca, ano e cor e informe se existe ou não um carro com essas características\n");
	printf("5-Sair\n");
	scanf("%d",&op);
	if(op==1){
		for(i=0;i<20;i++){
